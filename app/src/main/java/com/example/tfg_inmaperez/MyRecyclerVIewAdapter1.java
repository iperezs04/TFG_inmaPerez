...
public class MyRecyclerVIewAdapter1 extends RecyclerView.Adapter<MyRecyclerVIewAdapter1.ViewHolder> {
    ...
    public MyRecyclerVIewAdapter1(Context contexto, List<Peliseri>data) {
        this.mData = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View parten=mInflater.inflate(R.layout.recycler_view_item_2, parent, false);
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder (View itemView){
            ...
            portada=itemView.findViewById(R.id.imageViewRECYCLER2);
